file://<WORKSPACE>/src/main/java/com/example/diettracker/security/SecurityConfig.java
...
action parameters:
offset: 580
uri: file://<WORKSPACE>/src/main/java/com/example/diettracker/security/SecurityConfig.java
text:
```scala
